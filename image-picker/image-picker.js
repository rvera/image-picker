...
(function() {
  ...
  ImagePicker = (function() {
    ...
    ImagePicker.prototype.destroy = function() {
      ...
      this.select.show();
      if (this.opts.listen_for_reset) {
        return this.select.parents("form").unbind("reset");
      }
    };
    ...
    ImagePicker.prototype.build_and_append_picker = function() {
      ...
      if (this.opts.listen_for_reset) {
        return this.listen_for_reset();
      }
    };

    ImagePicker.prototype.listen_for_reset = function() {
      var _this = this;
      return this.select.parents("form").bind("reset", function() {
